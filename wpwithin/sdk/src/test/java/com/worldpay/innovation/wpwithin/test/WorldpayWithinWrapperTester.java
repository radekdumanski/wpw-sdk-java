...
public class WorldpayWithinWrapperTester {
    ...
    public static void main(String[] args) {
        ...
        String[] splitedPkgName = WorldpayWithinWrapperTester.class.getPackage().getName().split("\\.");
        String rpcLogFile = "rpc-within-" + splitedPkgName[splitedPkgName.length-1] + ".log";

        WPWithinWrapper sdk = new WPWithinWrapperImpl(host, port, true, rpcAgentListener, rpcLogFile);
